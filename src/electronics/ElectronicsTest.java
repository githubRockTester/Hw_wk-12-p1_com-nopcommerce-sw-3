...
public class ElectronicsTest extends Utility {
    ...
    public void verifyUserShouldNavigateToCellPhonesPageSuccessfully() {
        ...
        verifyActualAndExpectedText(By.xpath("//div[@class='page-title']"),
                "Cell phones");
    }
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
        ...
        verifyActualAndExpectedText(By.xpath("//div[@class='product-name']"),
                "Nokia Lumia 1020");

        // 2.7 Verify the price “$349.00”
        verifyActualAndExpectedText(By.xpath("//span[@id='price-value-20']"),
                "$349.00");
        ...
        verifyActualAndExpectedText(By.xpath("//div[@id='bar-notification']/div/p"),
        ...
        verifyActualAndExpectedText(By.xpath("//span[@class='product-subtotal']"),
                "$698.00");
        ...
        verifyActualAndExpectedText(By.xpath("//h1[contains(text(),'Welcome, Please Sign In!')]"),
        ...
        Thread.sleep(3000);
        verifyActualAndExpectedText(By.xpath("//div[text()='Your registration completed']"),
        ...
        verifyActualAndExpectedText(By.xpath("//span[contains(text(),'Shopping cart')]"),
                "Shopping cart");
        ...
        verifyActualAndExpectedText(By.xpath("//span[contains(text(),'Credit Card')]"),
                "Credit Card");
        ...
        verifyActualAndExpectedText(By.xpath("//td[@class='subtotal']/span"),
                "$698.00");
        ...
        verifyActualAndExpectedText(By.xpath("//h1[contains(text(),'Thank you')]"),
                "Thank you");


        //2.40 Verify the message “Your order has been successfully processed!”
        verifyActualAndExpectedText(By.xpath("//strong[contains(text(),'Your order has been successfully processed!')]"),
        ...
        verifyActualAndExpectedText(By.xpath("//h2[contains(text(),'Welcome to our store')]"),
